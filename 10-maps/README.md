...
- [Proof of concept](proof-of-concept.md) — routes from research readiness
  through the generic Intel-compatible x86-64 first CLI boot, protected service control, project BEAM runtime,
...
- [Managed actor runtime](managed-actor-runtime.md) — routes through BEAM
  ...
  evaluation, including internal-service studies for all thirteen components.
