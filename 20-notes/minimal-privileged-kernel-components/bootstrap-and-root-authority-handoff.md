...
| [seL4 information-flow enforcement](../../30-sources/murray-et-al-2013-sel4-information-flow.md) | System security reasoning depends on a suitable configured authority graph and declared assumptions | The result excludes several hardware effects and does not validate an Kay OS manifest |
