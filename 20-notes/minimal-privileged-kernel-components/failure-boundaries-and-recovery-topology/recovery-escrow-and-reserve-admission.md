...
Explicit resource attribution provides the accounting foundation; independently escrowed recovery authority is an Kay proposal. [1](../../../30-sources/banga-et-al-1999-resource-containers.md), [2](../../../30-sources/elkaduwe-et-al-2008-kernel-memory-isolation.md)
