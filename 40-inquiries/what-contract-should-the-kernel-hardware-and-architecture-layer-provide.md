...
The [active generic Intel-compatible x86-64 decision](../20-notes/proof-of-concept-requirements/x86-64-compatibility-envelope-and-test-fixtures.md)
...
processor-family qualification and each physical fixture's installed configuration are
